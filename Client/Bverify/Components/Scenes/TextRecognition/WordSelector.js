 ...
 class WordSelector extends Component {
  ...
  render() {
    ...
    return(
     ...
     <View>
                <Text style={{marginTop:'28%',top:-5,justifyContent:'center',alignSelf:'center',color:'#364b73',fontSize:14,fontWeight:'bold'}}>Select any recognised word to generate barcode</Text>
                </View>
     ...
     left:'20%',
      ...
      width:'60%',
        ...
        <Button title="Generate" color="white"  
