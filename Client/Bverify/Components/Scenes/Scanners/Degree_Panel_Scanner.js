...
import {degree_scan_list} from '../../Redux/Actions'
...
if (
 ...
 class Degree_Panel_Scanner extends Component {
...
if(item.length!==0){
this.props.degree_scan_list(item)
...
{this.handleTourch()}
      ...
      <View>
        ...
        <ActionSheet
          ...
          options={['Search','Scan Again','Scanned Codes History','cancel',
           ]}
          cancelButtonIndex={3}
...
this.props.degree_scan_list(reg_no)
...
export default connect(mapStatetoProps,{degree_scan_list})(Degree_Panel_Scanner);