...
import {Actions} from 'react-native-router-flux';
 ...
 class DegreeVerifyShowScreen extends Component {
...
setTimeout(()=>{
Actions.replace('DegreeVerifySecondTab');
...
export default connect(mapStatetoProps,{AlumniSystemForm,listData,Delete,Update,picker_form,date_picker}) (DegreeVerifyShowScreen);