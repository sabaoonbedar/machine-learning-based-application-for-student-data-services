...
<link rel="stylesheet" href="/assets/css/reporticon.css">
  <!-- =======================================================
...
Bverify is a Mobile(IOS and Android) and Web application (automation system) for the Department of ComputerScience, which provides the services for the teachers to automate different domain of problems inside department, it has enhanced system for uploading the data sets by just going through a single click, it provides facility that how many students are verified or not verified from the departement including the information about current students of the department along with the generated reports which avail teachers to know the details of their department just in one sight.
        </div>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <a href="#services" class="logo mr-auto"><img src="assets/img/logo.png" alt="" class="img-fluid"></a>
      ...
      <nav class="nav-menu d-none d-lg-block">
        ...
        <ul>
          ...
          <li><a href="#team">Team</a></li> --}}
           <li class="drop-down"><a class='header_button'>
            {{ Auth::user()->name }} </a>
            <ul>
...
{{--
  ...
  <main id="main">
    ...
    <!-- ======= Why Us Section ======= -->
    {{-- <section id="why-us" class="why-us section-bg mt-3">
     ...
     <section id="cta" class="cta">
      <div class="container" data-aos="zoom-in">
        ...
        <div class="text-center">
          ...
          <a class="cta-btn" href="{{route('bs_list')}}">List Of BS</a>
&nbsp;
          <a class="cta-btn" href="{{route('phd_list')}}">List Of PHD</a>
&nbsp;
        <a class="cta-btn" href="{{route('ms_list')}}">List Of MS</a>
          &nbsp;
          <a class="cta-btn" href="{{ route('msc_list') }}">List Of MSc</a>
        </div>
    ...
    <section id="services" class="services">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Services</h2>
          <p>Bverify Services</p>

          <a href={{route('reports')}}>
            <div class="divtop">
            <div class="iconreportsposition">
            <div class="pulse1"></div>
            <div class="pulse2"></div>
            <div class="icon_report"></div>
            </div>
            </a>
        </div>
        </div>
        ...
        <div class="row">
            ...
            <a href="{{route('students_import')}}">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box">
              <div class="icon"><i class="fas fa-users" style="font-size: 25px"></i></div>
              <h4><a href="{{route('students_import')}}">Current Students</a></h4>
  <a href="{{route('students_import')}}">  <p>Required Excel Sheet: here you have to upload the sheet for all the students who are currently studying in the BS Degree programe.</p></a>
            </div>
          </div></a>


        <a href="{{route('fee_import')}}">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box">
              <div class="icon"><i class="bx bx-file" style="font-size: 30px"></i></div>
              <h4><a href="{{route('fee_import')}}">Fee Section</a></h4>
              <a href="{{route('fee_import')}}">         <p>Required Excel Sheet: here you have to upload the sheet for all the students who have cleared the semester fees or not.</p></a>
            </div>
          </div></a>


          <a href="{{route('degree_import')}}">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box">
              <div class="icon"><i class="fas fa-user-graduate" style="font-size: 25px"></i></div>
              <h4><a href="{{route('degree_import')}}">Graduated Students</a></h4>
              <a href="{{route('degree_import')}}"><p>Required Excel Sheet: here you have to upload the sheet for all the students who had done any programe in the Department of Computer Science.</p></a>
            </div></a>
          </div>
