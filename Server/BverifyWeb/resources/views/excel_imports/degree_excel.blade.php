    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2 style="color:  #3084e4">Degree Section</h2>
      ...
      @endif
        ...
        @endif
            ...
            <form action="{{ route('DegreeImport') }}" method="POST" enctype="multipart/form-data" id="submit">
                @csrf
...
{{-- <a href={{route('dlist.index')}} class="excelbutton">
                      <div class="iconposition">
                        <i class="material-icons" style="font-size:55px">assignment_ind</i>
...
<br>
                ...
                >Upload List Data</a>
                <a class="importbutton" href="{{ route('DegreeExport') }}">Download List Data</a>
            </form>
        </div>
