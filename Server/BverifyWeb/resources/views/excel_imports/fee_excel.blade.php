...
<span class="landing-wrapper">
  <main id="main">
    ...
    <div class="alert">
        ...
        <div class="alertb"><strong>List of validations required for every field below:</strong>
        <ul>
...
{{-- This is the button of View list --}}

            <a href="{{route('flist.index')}}">
                <div class="divtop">
...
{{-- end here --}}
            ...
            <form action="{{ route('FeeImport') }}" method="POST" enctype="multipart/form-data" id="submit">
                @csrf
                ...
                >Upload List Data</a>
                <a class="importbutton" href="{{ route('FeeExport') }}">Export List Data</a>
            </form>
        </div>
    ...
    </section><!-- End About Section -->   <script>
