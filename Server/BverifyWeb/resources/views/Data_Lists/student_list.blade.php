    ...
    <a href="{{route('homepage')}}" class="logo mr-auto"><img src="assets/img/logo.png" alt="" class="img-fluid"></a>
      ...
      <nav class="nav-menu d-none d-lg-block">
        ...
        <ul>
          ...
          <li><a href="{{route('students_import')}}"> <i class="fa fa-arrow-circle-left" style="font-size:16px;" >
          </i>&nbsp;back</a></li>
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <h2 style="color:  #3084e4">Students Section  </h2></span>
...
<div class="card-body">
    ...
    <br><div class="tablelocation" style="margin-left: -9%">
...
<img src="{{'uploads//'. $item->user_image }}"  class="shadow-lg"  style=" padding:3px;  border-radius: 50%; width: 12rem; height: auto; " />
