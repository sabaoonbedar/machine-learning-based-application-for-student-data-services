    ...
    <a href="{{route('homepage')}}" class="logo mr-auto"><img src="assets/img/logo.png" alt="" class="img-fluid"></a>
      ...
      <nav class="nav-menu d-none d-lg-block">
        ...
        <ul>
          ...
          <li><a href="{{route('degree_import')}}"> <i class="fa fa-arrow-circle-left" style="font-size:16px;" >
          </i>&nbsp;back</a></li>
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <h2 style="color:  #3084e4">Degree Section  </h2></span>
          <p>List of Graduated Students</p>
        </div>
...
<img src="{{'uploads//'. $item->user_image }}"  class="rounded-circle shadow-lg rounded-circle"  style=" padding:3px; width:12rem; height:auto" />
     ...
     <a class="form_image_button" style ="align-items: center" href="{{route('dlist.edit',$encrypted)}}"> <span class="glyphicon glyphicon-edit"></span> Add Picture</a>
