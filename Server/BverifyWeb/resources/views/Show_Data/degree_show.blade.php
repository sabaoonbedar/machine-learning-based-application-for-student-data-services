...
<body>
  ...
  <div class="modal-header"  style="background-color: #19293d; font-size:12px">
...
@endif
        ...
        <div class="card-body">
            <div class="card-body iconbox_color_red">
              {{-- <img src="assets/img/testimonials/testimonials-1.jpg" class="testimonial-img" alt=""> --}}
              <h3>{{$d_data->name}}   <br><br><div class="blink_me"><div class="notverifytext">Not Verified<div></div> </h3>
