    ...
    <div class="page-content">
          <div class="wizard-v5-content">
			<div class="wizard-form">
		        <form class="form-register" id="submit" action={{route('dlist.update',$d_item->id)}}  method="POST">
			            ...
			            <section>
			                <div class="inner">
								<div class="form-row">
                                    ...
                                    <input type="text" placeholder="ex: sabaoon" class="form-control" id="name" name="name" value="{{$d_item->name}}" class="@error('title') is-invalid @enderror" required>
 @error('name')
...
@enderror
									...
									<div class="form-holder">
										...
										<input type="text" placeholder="ex: abdul baseer" class="form-control" id="father_name" name="father_name" value="{{$d_item->father_name}}">
									</div>
								</div>
								{{-- <div class="form-row">
									<div id="radio">
                                ...
                                <div class="form-holder">
                                    ...
                                    <input type="text" placeholder="ex: abc/234/s" class="form-control" id="registration_num" name="registration_num" value="{{$d_item->registration_num}}">
                                </div>
                                </div>
								<div class="form-row">
									<div class="form-holder form-holder-2">
										<label for="address">Email Address</label>
										<input type="text" placeholder="Baidar.sabaoon@gmail.com" class="form-control" id="email_address" name="email_address" value="{{$d_item->email_address}}">
								...
								<div class="form-row">
									<div class="form-holder">
										...
										<input type="text" placeholder="03-04-2015" class="form-control" id="admission_date" name="admission_date" value="{{$d_item->admission_date}}">
									</div>
									<div class="form-holder">
										<label for="code">Graduation Date</label>
										<input type="text" class="form-control" id="graduation_date"  placeholder="03-04-2019" name="graduation_date" value="{{$d_item->graduation_date}}">
									</div>
								</div>
			                ...
			                <div class="inner">
								<div class="form-row">
									<div class="form-holder">
										...
										<input type="text" placeholder="17301-9992-213-1" class="form-control input-step-2" id="cnic" name="cnic" value="{{$d_item->cnic}}">
										{{-- <span><i class="zmdi zmdi-search"></i></span> --}}
									</div>
									<div class="form-holder">
										<label for="branch">Passport No</label>
										<input type="text" placeholder="P0033343442" class="form-control input-step-2" id="passport_num" name="passport_num" value="{{$d_item->passport_num}}">
									</div>
								</div>
								{{-- <div class="form-row">
									<div class="form-holder form-holder-2">
								...
								<div class="form-row">
									<div class="form-holder form-holder-2">
										<label for="account_name">Status</label>
										<input type="text" placeholder="Varified or Not Varified" class="form-control input-step-2-1" id="status" name="status" value="{{$d_item->status}}">
									</div>
								</div>
								{{-- <div class="form-row">
									<div class="form-holder form-holder-2">
